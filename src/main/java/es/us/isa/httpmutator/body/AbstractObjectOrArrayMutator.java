...
import static es.us.isa.httpmutator.util.OperatorNames.DISORDER_ELEMENTS;
import static es.us.isa.httpmutator.util.OperatorNames.EMPTY;
import static es.us.isa.httpmutator.util.OperatorNames.REMOVE_ELEMENT;
import static es.us.isa.httpmutator.util.OperatorNames.REMOVE_OBJECT_ELEMENT;
