package es.us.isa.httpmutator.body.value.double0;
...
import es.us.isa.httpmutator.body.value.double0.operator.DoubleMutationOperator;
import es.us.isa.httpmutator.body.value.double0.operator.DoubleReplacementOperator;
